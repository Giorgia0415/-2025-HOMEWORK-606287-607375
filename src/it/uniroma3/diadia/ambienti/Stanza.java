...
public class Stanza {
    ...
    public void impostaStanzaAdiacente(String direzione, Stanza stanza) {
    	...
    	for(int i=0; i<this.direzioni.length; i++)
    	 ...
    	 //se non ha aggiornato la stanza vuol dire che o è stata inserita come parametro una direzione che non è considerata (es nord-est)
    	 //o nella direzione inserita come parametro ancora non era presente nessuna stanzaAdiacente
